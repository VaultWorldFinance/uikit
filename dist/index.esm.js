...
import { ChainId } from '@vaultworld/sdk';
...
var FloatingPanIcon = styled(Icon$K)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/VaultWorldFinance/",
                target: '_blank',
            },
            {
                label: "Docs",
                href: "https://VaultWorldFinance.gitbook.io/vaultworld/",
            },
            {
                label: "Blog",
                href: "https://vaultworld.medium.com/",
            },
        ],
    },
];
...
var templateObject_1$K, templateObject_2$g, templateObject_3$8, templateObject_4$2, templateObject_5$1;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", 
    // inputBorder: "#cccccc",
    inputSecondary: "#cccccc", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#FF720D", activeButton: "#397f49", borderColor: "#E9EAEB", card: "#FFFFFF", nav: "#FFFFFF", tag: "#ae7de8", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#e9f1fd", background: "#1f2b46", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#0a0e17", input: "#483f3b", 
    // inputBorder: "#cccccc",
    inputSecondary: "#cccccc", primaryDark: "#d95b00", tertiary: "#2d2f37", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#FF720D", activeButton: "#397f49", borderColor: "#524B63", card: "#121827", nav: "#204829", tag: "#ae7de8", gradients: {
